...
public class PaymentParam {
    ...
    public PaymentParam(String number, String type, int expire_month, int expire_year, String cvv2, String first_name, String last_name, Billing_address billing_address,/*String plan_test,String createdat,*/ String version, String user_id, int client_id,boolean cardRenew) {
        this.number = number;
        this.type = type;
